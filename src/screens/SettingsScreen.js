...
const SettingsScreen = ({ navigation }) => {
  ...
  const openNotificationSettings = () => {
    if (Platform.OS === 'ios') {
      ...
      Alert.alert(
        'Ikke støttet',
        'Åpne varslingsinnstillinger via systeminnstillingene på enheten din.'
      );
    }
  };
  ...
  const handleLanguageChange = async (languageCode) => {
    try {
      ...
      console.warn('Kunne ikke endre språk', error);
      Alert.alert('Feil', 'Kunne ikke oppdatere språk');
    } finally {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: getLanguageLabel(i18n.language),
            ...
            {LANGUAGE_OPTIONS.map((option) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  i18n.language === option.code && styles.languageOptionRowActive,
                ]}
                onPress={() => handleLanguageChange(option.code)}
                disabled={languageLoading && i18n.language === option.code}
              >
                <View style={styles.languageOptionLabel}>
                  ...
                  <Text
                    style={[
                      ...
                      { color: themedColors.neutral[500] },
                    ]}
                  >
...
const styles = StyleSheet.create({
  ...
  languageOptionRow: {
    ...
    borderBottomColor: defaultColors.neutral[200],
  },
